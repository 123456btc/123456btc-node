/**
 * 123456btc MCP Server
 *
 * 让 AI Agent (Claude Code, Cursor, OpenCode, Codex 等) 通过 MCP 协议
 * 直接操作 123456btc 去中心化策略网络。
 *
 * 启动方式: npx tsx src/mcp/server.ts
 * 传输方式: STDIO (标准输入输出)
 */
...
async function main() {
  ...
  console.error('[123456btc MCP] Server started (stdio)');
}
